...
{
    public class SystemCollider : ISystem
    {
        ...
        public SystemCollider(ref EntityManager entityManager, ref Camera pCamera)
        {
        ...
        /// <summary>
        /// Clears the last entity that triggered the collision detections
        /// </summary>
        ...
        /// <summary>
        /// Clears the last entity that triggered the collision detection and updates the list as that entity no longer exist
        /// </summary>
